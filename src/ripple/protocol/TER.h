...
enum TECcodes : TERUnderlyingType {
    ...
    tecBAD_XCHAIN_TRANSFER_ISSUE = 169,
    tecXCHAIN_NO_CLAIM_ID = 170,
    tecXCHAIN_BAD_CLAIM_ID = 171,
    tecXCHAIN_CLAIM_NO_QUORUM = 172,
    tecXCHAIN_PROOF_UNKNOWN_KEY = 173,
    tecXCHAIN_CREATE_ACCOUNT_NONXRP_ISSUE = 174,
    tecXCHAIN_WRONG_CHAIN = 175,
    tecXCHAIN_REWARD_MISMATCH = 176,
    tecXCHAIN_NO_SIGNERS_LIST = 177,
    tecXCHAIN_SENDING_ACCOUNT_MISMATCH = 178,
    tecXCHAIN_INSUFF_CREATE_AMOUNT = 179,
    tecXCHAIN_ACCOUNT_CREATE_PAST = 180,
    tecXCHAIN_ACCOUNT_CREATE_TOO_MANY = 181,
    tecXCHAIN_PAYMENT_FAILED = 182,
    tecXCHAIN_SELF_COMMIT = 183,
    tecXCHAIN_BAD_PUBLIC_KEY_ACCOUNT_PAIR = 184,
    tecXCHAIN_CREATE_ACCOUNT_DISABLED = 185,
};
