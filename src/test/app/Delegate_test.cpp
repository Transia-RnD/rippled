...
#pragma pop_macro("TRANSACTION")
        ...
        // ====================================================================
        // 61 = 57 develop baseline (56 prior + 1 new Sponsor tx) + 4 new
        // delegable txs from the AMM curves bundle (AMMCollectFees,
        // AMMBinCreate, AMMBinDestroy, and the CL-position-transfer tx).
        // All four follow the existing AMMDeposit / AMMWithdraw delegation
        // surface (pool-scoped, AMM SLE checked at preclaim) — no new
        // authority is granted to the delegate that they couldn't already
        // exercise via the pre-existing AMM tx surface.
        std::size_t const expectedDelegableCount = 61;
