...
Json::Value
doDexCandles(RPC::JsonContext&);
Json::Value
doDexTrades(RPC::JsonContext&);
Json::Value
doDexTokenSummary(RPC::JsonContext&);
Json::Value
doDexPairs(RPC::JsonContext&);
Json::Value
doDexPools(RPC::JsonContext&);
Json::Value
doDexStatus(RPC::JsonContext&);
Json::Value
doDexTicks(RPC::JsonContext&);
Json::Value
