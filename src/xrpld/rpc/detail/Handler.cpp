...
Handler const handlerArray[]{
    ...
    {"export_payment", byRef(&doExportPayment), Role::USER, NO_CONDITION},
    {"export_status", byRef(&doExportStatus), Role::USER, NO_CONDITION},
    ...
    {"get_margin_status", byRef(&doGetMarginStatus), Role::USER, NO_CONDITION},
