...
Handler const handlerArray[]{
    ...
    {"dex_amm_history", byRef(&doDexAMMHistory), Role::USER, NO_CONDITION},
    {"dex_candles", byRef(&doDexCandles), Role::USER, NO_CONDITION},
    {"dex_pairs", byRef(&doDexPairs), Role::USER, NO_CONDITION},
